...
SYSTEM_PROMPT = (
    ...
    "`upload_document` (its content is plain text / Markdown you provide).\n"
    ...
    "- To let the operator download a document, call `get_document` — the interface "
    "shows Markdown and PDF download buttons for it (Markdown to edit, PDF to read); "
    "do not paste the whole file into your reply.\n"
