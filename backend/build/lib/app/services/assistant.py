...
def build_tools() -> list[ToolSpec]:
    ...
    return [
        ...
        _tool("get_release_changes",
              ...
              "this one's. Also reports Chart.yaml dependencies with no linked "
              "repository and why a baseline may be missing — relay those to the "
              "operator instead of treating them as 'no changes'.",
